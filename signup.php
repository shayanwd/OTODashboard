	...
	<div class="flex-grow-1">
		<div class="h-100 d-md-flex align-items-end auth-side-img">
			<div class="col-sm-10 auth-content w-auto">
				...
				<h4 class="text-white font-weight-normal">Register to your account and made member of the Stresser Dashboard Template.<br/>Do not forget to play with live customizer</h4>
			</div>
		</div>
		<div class="auth-side-form">
			<div class=" auth-content">
				...
				<div class="text-center">
					...
					<p class="mt-4">Already have an account? <a href="signin.html" class="f-w-400">Signin</a></p>
				</div>
			</div>
		</div>
	</div>
