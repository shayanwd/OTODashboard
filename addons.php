...
<head>
    <title>Stresser.su|Addons</title>
</head>
        ...
        <div class="pcoded-content">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-4 text-primary">Contact Staff to Purchase Extra Concurrent</h6>
							<div class="row d-flex align-items-center">
								<button type="button" class="order-btn mt-4">Buy</button>
                            </div>
                        </div>
                    </div>
				</div>
				...
				<div class="col-md-6 col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-4 text-primary">COMING SOON</h6>
                            <div class="row d-flex align-items-center">
								<button type="button" class="order-btn mt-4">Buy</button>
                            </div>
