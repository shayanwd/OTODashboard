	...
	<div class="flex-grow-1">
		<div class="h-100 d-md-flex align-items-end auth-side-img">
			<div class="col-sm-10 auth-content w-auto">
				...
				<h4 class="text-white font-weight-normal">Signin to your account and get explore the Stresser Dashboard Template.<br />Do not forget to play with live customizer</h4>
			</div>
		</div>
		<div class="auth-side-form">
			<div class=" auth-content">
				...
				<div class="text-center">
					...
					<p class="mb-2 mt-4 text-muted">Forgot password? <a href="reset.html" class="f-w-400">Reset</a></p>
					<p class="mb-0 text-muted">Don’t have an account? <a href="signup.html" class="f-w-400">Signup</a></p>
				</div>
			</div>
		</div>
	</div>
